...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s foundation-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  foundation-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded foundation transaction") + "\n" +
              "  foundation-tx [options] -create [commands]   " + _("Create hex-encoded foundation transaction") + "\n" +
              "\n";
