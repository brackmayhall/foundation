...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/foundation-project/foundation>";
    const std::string URL_WEBSITE = "<https://foundation.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Foundation version %s\n", FormatFullVersion());
}
