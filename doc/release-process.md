...
* Update manpages, see [gen-manpages.sh](https://github.com/foundation-project/foundation/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [foundation-detached-sigs](https://github.com/foundation-project/foundation-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the foundation.org server.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/foundation-project/foundation/releases/new) with a link to the archived release notes.
