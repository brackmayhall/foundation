...
{
    const char* pszTimestamp = "Trump’s Silence Leaves Struggle Against Russia Without Leader";
...
public:
    CMainParams() {
         ...
         */
        pchMessageStart[0] = 0x79; // 121
        pchMessageStart[1] = 0x24; // 36
        pchMessageStart[2] = 0x99; // 153
        pchMessageStart[3] = 0xbe; // 190
        nDefaultPort = 9454;
        nPruneAfterHeight = 100000;
        
        // time, nonce, bits, version, coin count
        genesis = CreateGenesisBlock(1518927823, 2085664418, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31ef0c6f394766818734571e1177badfa73318cf7078f2968f16cb33fe28fb64"));
        ...
        chainTxData = ChainTxData{
            ...
            1518927823, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        pchMessageStart[0] = 0x5c; // 92
        pchMessageStart[1] = 0x89; // 137
        pchMessageStart[2] = 0xb7; // 183
        pchMessageStart[3] = 0xc1; // 193
        nDefaultPort = 19455;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1518937147, 613401, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
        ...
        pchMessageStart[0] = 0xbc; // 188
        pchMessageStart[1] = 0xe7; // 231
        pchMessageStart[2] = 0xd9; // 217
        pchMessageStart[3] = 0x6c; // 108
        nDefaultPort = 19446;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1518937504, 98210, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x99ef1b54515348f9bf291c471e77b52315fd862ea50fc2cb72c618084cbb35c7"));
        assert(genesis.hashMerkleRoot == uint256S("0x21862b7a4e1d4b32c97f4fcdebc2d8cfc8c09dce3081567c230e2b9cbb4b52cb"));
